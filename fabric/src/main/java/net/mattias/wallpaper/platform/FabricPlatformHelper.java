...
public class FabricPlatformHelper implements IPlatformHelper {
    ...
    @Override public <T extends Item> Supplier<T> registerItem(String name, Supplier<T> item) {
        T registered = Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(WallpaperCommon.MOD_ID, name), item.get());
        return () -> registered;
    }

    @Override public <T extends CreativeModeTab> Supplier<T> registerCreativeTab(String name, Supplier<T> tab) {
        T registered = Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, new ResourceLocation(WallpaperCommon.MOD_ID, name), tab.get());
        return () -> registered;
    }
